...
class FrontExpl
{
    public:
        FrontExpl()
        {
            ...
            tb3_1_FE_map_pub = nh.advertise<nav_msgs::OccupancyGrid>("edges_map_1", 10);
            region_map_pub = nh.advertise<nav_msgs::OccupancyGrid>("region_map_1", 10);
        ...
        void neighborhood(int cell)
        {
            ...
            below_before_i = cell - FE_tb3_1_map.info.width - 1;
            below_i = cell - FE_tb3_1_map.info.width;
            below_after_i = cell - FE_tb3_1_map.info.width + 1;
            before_i = cell-1;
            after_i = cell+1;
            top_before_i = cell + FE_tb3_1_map.info.width - 1;
            top_i = cell + FE_tb3_1_map.info.width;
            top_after_i = cell + FE_tb3_1_map.info.width + 1;
        ...
        // {
        //     edge_after = cell+1;
        //     edge_top_before = cell + FE_tb3_1_map.info.width - 1;
        //     edge_top = cell + FE_tb3_1_map.info.width;
        //     edge_top_after = cell + FE_tb3_1_map.info.width + 1;
        // }
...
{
    ros::init(argc, argv, "other_tb_FE_node");
    FrontExpl FE;
    FE.main_loop();
    ros::spin();
