    ...
    public:
        ...
        void main_loop()
        {
            ...
            while (ros::ok())
            {
                ...
                FE_tb3_0_map.header.frame_id = "tb3_0_FE_map";
                ...
                // Move to goal
                goal_init.target_pose.header.frame_id = "tb3_0/map"; // Needs to be AN ACTUAL FRAME
                goal_init.target_pose.header.stamp = ros::Time();
                goal_init.target_pose.pose.position.x = robot_pose_.position.x + 0.5;
                goal_init.target_pose.pose.position.y = robot_pose_.position.y + 1.5;
